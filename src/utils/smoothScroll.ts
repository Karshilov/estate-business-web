/**
 * Copyright  © 2021 All Rights Reserved | OI-wiki
 * Modified by Karshilov 2021
 */
...
const smoothScrollTo: SmoothScrollToType = (yCoordinate, duration = -1, optimizeForSmallScreen = true) => {
  ...
  const el: Nullable<HTMLDivElement> = document.querySelector('div .content')

  if (!el) throw new Error('找不到主面板')
